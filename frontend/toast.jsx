...
const Toast = ({ type, message, onClose }) => {
  ...
  return (
    <div
      id={`toast-${type}`}
      className={`fixed top-4 right-4 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow ${
        type === 'success'
    ...
    >
      ...
      <div className="ml-3 text-sm font-normal">{displayMessage}</div>
      <button
        onClick={onClose}
        type="button"
